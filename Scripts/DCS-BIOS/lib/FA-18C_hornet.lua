BIOS.protocol.beginModule("FA-18C_hornet", 0x5400)
...
definePotentiometer("SAI_SET", 32, 3003, 214, {0, 1}, "Standby Attitude Reference Indicator", "Adjust Attitude")
...
defineToggleSwitch("LDG_TAXI_SW", 8, 3004, 237, "Exterior Lights", "LDG/TAXI LIGHT Switch")
...
definePotentiometer("RADALT_HEIGHT", 30, 3002, 291, {0, 1}, "Radar Altimeter", "Set low altitude pointer")
