  ...
  Start = function(self)
    ...
    local connect_init =
      ...
      function()
        ...
        socket.try(connect_1:setpeername("127.0.0.1", 29375))
      ...
      function()
        if connect_1 then
          ...
          if obj.Name == "Mi-8MT" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;RotorRPM=%.0f;VlctVectors=%s;altAgl=%.2f;PanShake=%s;d=0;ACCs=%s;d=0;IAS=%.2f;12_Wind=%s;altASL=%.2f;14d=0;Payload=%s;d=0;d=0;d=0;d=0;d=0;TAS=%.2f;Flares=%s",
              t,
              obj.Name,
              myselfData,
              mainRotorRPM,
          ...
          elseif obj.Name == "UH-1H" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;RotorRPM=%.0f;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Shells=%i;ACCs=%s;IAS=%.2f;d=0;12_Wind=%s;altASL=%.2f;14d=0;15_Payload=%s;16d=0;17d=0;18_LDoor=%.2f;19_RDoor=%.2f;20_deadPilot=%.2f;TAS=%.2f;Flares=%s",
              t,
              obj.Name,
              myselfData,
              mainRotorRPM,
          ...
          elseif obj.Name == "Ka-50" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;RotorRPM=%.0f;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Gun=%s~%.3f;ACCs=%s;IAS=%.2f;d=0;12_Wind=%s;13_altASL=%.2f;14d=0;15_Payload=%s;16d=0;17d=0;18d=0;19d=0;20_APU=%s;TAS=%.2f;Flares=%s;Chaff=%s",
              t,
              obj.Name,
              myselfData,
              mainRotorRPM,
          ...
          elseif
           ...
           then -- Gazelle
            ...
            stringToSend=string.format("T=%.3f;N=%s;SelfData=%s;RotorRPM=%.0f;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Shells=%i;ACCs=%s;IAS=%.2f;d=0;12_Wind=%s;altASL=%.2f;14_RadarAltimeterMeter=%.2f;15_Payload=%s;16_RAltimeterStatus=%s;17d=0;18d=0;19d=0;20d=0;21_TAS=%.2f;Flares=%s",t,obj.Name,myselfData,mainRotorRPM,velocityVectors,altAgl,"000",CannonShells,AccelerationUnits,IAS,windVelocityVectors,altAsl,RAltimeterMeter,PayloadInfo, StatusString,tas, CM.flare)
...
-------------------------------------------------------------------------------------------------------------------------------------------------------
          elseif obj.Name == "P-51D" or obj.Name == "P-51D-30-NA" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;EngRPM=%.0f;VlctVectors=%s;altAgl=%.2f;PanShake=%s;CannonShells=%.0f;ACCs=%s;GreenLight=%.1f;11_MP-WEP=%.2f~%.2f;12_Wind=%s;altASL=%.2f;AoA=%.1f;15_Payload=%s;16d=0;17d=0;18d=0;19d=0;20d=0;TAS=%.2f",
              t,
              obj.Name,
              myselfData,
              Engine_RPM,
          ...
          elseif obj.Name == "TF-51D" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;EngRPM=%.0f;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Gun=%s;ACCs=%s;GreenLight=%.1f;MP-WEP=%.2f~%.2f;12_Wind=%s;altASL=%.2f;AoA=%.1f;15d=0;16d=0;17d=0;18d=0;19d=0;20d=0;TAS=%.2f",
              t,
              obj.Name,
              myselfData,
              Engine_RPM,
          ...
          elseif obj.Name == "FW-190D9" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;EngineRPM=%.2f;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Gun=%s;ACCs=%s;Grn-Red-Lights=0;MP-MW=%.2f~%.2f;12_Wind=%s;altASL=%.2f;14_AoA=%.1f;15_Payload=%s;16d=0;17d=0;18d=0;19d=0;20d=0;TAS=%.2f",
              t,
              obj.Name,
              myselfData,
              Engine_RPM,
          ...
          elseif obj.Name == "Bf-109K-4" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;EngineRPM=%.2f;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Gun=%i;9_ACCs=%s;10_Grn-Red-Lights=0;11_MP-MW=%.2f~%.2f;12_Wind=%s;altASL=%.2f;14_AoA=%.1f;15_Payload=%s;16d=0;17d=0;18d=0;19d=0;20d=0;TAS=%.2f",
              t,
              obj.Name,
              myselfData,
              Engine_RPM,
          ...
          elseif obj.Name == "SpitfireLFMkIX" or obj.Name == "SpitfireLFMkIXCW" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;EngRPM=%.0f;VlctVectors=%s;altAgl=%.2f;PanShake=%s;CannonShells=%.0f;ACCs=%s;d10=0;d11=0~0;12_Wind=%s;altASL=%.2f;AoA=%.1f;15_Payload=%s;16d=0;17d=0;18d=0;19d=0;20d=0;TAS=%.2f",
              t,
              obj.Name,
              myselfData,
              Engine_RPM,
          ...
          elseif obj.Name == "F-86F Sabre" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;EngineRPM=%.0f;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Gun=%s;ACCs=%s;Gr-RedLight=0;11d=0;12_Wind=%s;altASL=%.2f;AoA=%.2f;15_PayloadInfo=%s;16d=0;17d=0;18d=0;19d=0;20d=0;TAS=%.2f",
              t,
              obj.Name,
              myselfData,
              Engine_RPM,
          ...
          elseif obj.Name == "A-10C" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;EngRPM=%s;VlctVectors=%s;altAgl=%.2f;PanShake=%s;GunShells=%.0f;ACCs=%s;LG=%s;DragChute=%s;12_Wind=%s;altASL=%.2f;AoA=%.2f;Payload=%s;Flaps=%.2f;d=0;18_Canopy=%.2f;19d=0;APU=%.2f;TAS=%.2f;Flares=%s;Chaff=%s",
              t,
              obj.Name,
              myselfData,
          ...
          elseif obj.Name == "MiG-21Bis" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;EngRPM=%s;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Gun=%s;ACCs=%s;11d=0;d=0;12_Wind=%s;altASL=%.2f;AoA=%.2f;Payload=%s;Flaps=%.2f;d=0;Canopy=%.1f;19_SPS=%.1f;20d=0;TAS=%.2f;Flares=%s;Chaff=%s",
              t,
              obj.Name,
              myselfData,
              Engine_RPM,
          ...
          elseif obj.Name == "MiG-15bis" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;EngineRPM=%i;VlctVectors=%s;altAgl=%.2f;PanShake=0;Gun=%s;ACCs=%s;Gr-RedLight=%s;d=0;12_Wind=%s;altASL=%.2f;AoA=%.2f;Payload=%s;Flaps=0;17d=0;18_Canopy=%.1f;19d=0;20d=0;TAS=%.2f",
              t,
              obj.Name,
              myselfData,
              Engine_RPM,
          ...
          elseif obj.Name == "Hawk" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;EngRPM=%s;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Gun=%s;ACCs=%s;10_Gr-RedLight=%s;d=0;12_Wind=%s;d=0;AoA=%.2f;15_PayloadInfo=%s;d=0;d=0;d=0;d=0;d=0;TAS=%.2f",
              t,
              obj.Name,
              myselfData,
              "Engine_RPM=00",
          ...
          elseif obj.Name == "L-39C" or obj.Name == "L-39ZA" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;EngRPM=%s;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Gun=%s;ACCs=%s;Gr-RedLight=0;d=0;12_Wind=%s;altASL=%.2f;AoA=%.2f;15_Payload=%s;16d=0;17d=0;18Canopy1=%.2f;19Canopy2=%.2f;20d=0;TAS=%.2f",
              t,
              obj.Name,
              myselfData,
              Engine_RPM,
          ...
          elseif obj.Name == "M-2000C" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;d=0.0f;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Gun=%s;ACCs=%s;d10=0;11d=0;12_Wind=%s;altASL=%.2f;AoA=%.2f;15_PayloadInfo=%s;16d=0;M=%.4f;18d=0;19d=0;20d=0;TAS=%.2f;Flares=%s;Chaff=%s",
              t,
              obj.Name,
              myselfData,
              velocityVectors,
          ...
          elseif obj.Name == "F-5E" or obj.Name == "F-5E-3" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;Engine_RPM=%s;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Gun=%s;ACCs=%s;d10=0;11d=0;12_Wind=%s;altASL=%.2f;AoA=%.2f;15_PayloadInfo=%s;16d=0;M=%.4f;18d=0;19d=0;20d=0;TAS=%.2f;Flares=%s;Chaff=%s",
              t,
              obj.Name,
              myselfData,
              Engine_RPM_left .. "~" .. Engine_RPM_right,
          ...
          elseif obj.Name == "AJS37" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;Engine_RPM=%.2f;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Gun=%s;ACCs=%s;d10=0;11d=0;12_Wind=%s;altASL=%.2f;AoA=%.2f;15_PayloadInfo=%s;16d=0;M=%.4f;18d=0;19d=0;20d=0;TAS=%.2f;Flares=%s;Chaff=%s",
              t,
              obj.Name,
              myselfData,
              Engine_RPM,
          ...
          elseif obj.Name == "AV8BNA" then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;Engine_RPM=%.2f;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Gun=%s;ACCs=%s;d10=0;IAS=%.2f;12_Wind=%s;altASL=%.2f;AoA=%.2f;15_PayloadInfo=%s;16d=0;M=%.4f;18d=0;19d=0;20d=0;TAS=%.2f;Flares=%s;Chaff=%s",
              t,
              obj.Name,
              myselfData,
              "0",
      ...
      if RPM == nil then 
        RPM = "0~0"
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;Engine_RPM=%s;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Gun=%s;ACCs=%s;d10=0;IAS=%.2f;12_Wind=%s;altASL=%.2f;AoA=%.2f;15_PayloadInfo=%s;16d=0;M=%.4f;18d=0;19d=0;20d=0;TAS=%.2f;Flares=%s;Chaff=%s",
              t,
              obj.Name,
              myselfData,
              RPM,
          ...
          elseif string.find(obj.Name, "F-14") then
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;Engine_RPM=%s;VlctVectors=%s;altAgl=%.2f;PanShake=%s;Gun=%s;ACCs=%s;d10=0;IAS=%.2f;12_Wind=%s;altASL=%.2f;AoA=%.2f;15_PayloadInfo=%s;16d=0;M=%.4f;18d=0;19d=0;20d=0;TAS=%.2f;Flares=%s;Chaff=%s;%s",
              t,
              obj.Name,
              myselfData,
              RPM,
...
-------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            stringToSend =
              string.format(
              "T=%.3f;N=%s;SelfData=%s;EngRPM=%s;VlctVectors=%s;altAgl=%.2f;MCPState=%s;CannonShells=%.0f;ACCs=%s;LG=%.2f;DragChute=%.2f;12_Wind=%s;altASL=%.2f;AoA=%.2f;PayloadInfo=%s;Flaps=%.2f;M=%.2f;Canopy=%.2f;Wings=%.2f;20d=0;TAS=%.2f;Flares=%s;Chaff=%s",
              t,
              obj.Name,
              myselfData,
              engineRPM,
