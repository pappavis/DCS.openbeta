...
function _M.DefaultMulticastSender:send(msg)
	socket.try(self.conn:sendto(msg, "239.255.50.10", 12843))
end
...
function _M.init(args)
	...
	_M.exportDeviceListener:setsockname("127.0.0.1", 12846)
