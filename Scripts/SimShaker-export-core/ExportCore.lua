...
function ExportCore.init()
	dofile(lfs.writedir()..[[Scripts\SimShaker-export-core\Network.lua]])
	dofile(lfs.writedir()..[[Scripts\SimShaker-export-core\KeyValueStore.lua]])
	dofile(lfs.writedir()..[[Scripts\SimShaker-export-core\Protocol.lua]])
